...
<div class="clientes-menu">
  <a class="clientes-menu-item2 mayusculas"><?php echo $row["contacto"].' <br> '.$row["apellido_materno"].' <br> '.$row["apellido_paterno"]; ?></a>
  ...
  <div class="campitem-cliente">
    ...
    <div class="campb111 dosporch">
      <div class="dattaclieti0">
        <div class="dattaclieti"><strong>Nombre Completo:</strong> <span class="mayusculas">  <?php echo $row["contacto"].' '.$row["apellido_materno"].' '.$row["apellido_paterno"];?></span></div>           
...
<?php };?>
  ...
  <div class="campitem-cliente2">
    ...
    <div class="campd dosporch">
      ...
      <select name="fecha_nacimiento_a" id="fecha_nacimiento_a"  class="hospitalx <?= $clase_bl?>" <?= $desha?>>
          ...
          <?php for ($i=194; $i < 2099 + 30; $i++) { ?>
                  <option value="<?= $i;?>" <?php if($i == '1980'){echo 'selected';};?>> <?= $i;?> </option>
          <?php  };   ?>
      </select>
    </div>
    <div class="campd dosporch">
  ...
  <div class="campitem-cliente2">
    ...
    <div class="campd dosporch">
      <div>Celular</div>
      <input type="text" name="celular" class="hospitalx" placeholder="Celular"  maxlength="10" value="<?php echo $row["celular"];?>"/>
    </div>
    <div class="campd dosporch">
      <?php if ($id != ''){?>
      <div>Telefono</div>
...
//            echo $desde_cuandot[1].'/'.$desde_cuandot[0];
  ...
  <div class="campitem-cliente" id="Familiar3" style="display:<?php if($row["tipo_casa"] == 'Familiar'){echo 'block';}else{echo 'none';};?>">
    <div class="campb">
      <div>Nombre del familiar</div>
      <input type="text" name="familiar_nombre" id="textfield" class="mayusculas" value="<?php echo $row["familiar_nombre"];?>"/>
    </div>
    <div class="campb dosporch">
      <div>Parentesco</div>
...
<span class="titlecol-ad">Perfil Laboral</span>
  ...
  <div class="campitem-cliente2" id="trab3" style="display: <?php if($row["ocupacion"] == 'Empleado'){echo 'block';}else{echo 'none';};?>">
    <div class="campb">
      ...
      <input type="text" name="jefe_nombre" id="textfield" class="mayusculas" value="<?php echo $row["jefe_nombre"];?>"/>
...
<span class="titlecol-ad">Perfil Economico</span>
  ...
  if($row["estado_civil"] == 'Casado' || $row["estado_civil"] == 'Union_Libre'){echo 'block';}else{echo 'none';};?>">
      ...
      <input type="text" name="nombre_pareja_pe" id="textfield" class="mayusculas" value="<?php echo $row["nombre_pareja_pe"];?>"/>
     </div>
  </div>
...
<div id="copy_ref<?= $cant_ref_act;?>">
  ...
  <div class="campitem-cliente2">
    <div class="campb">
      <div>Nombre</div>
      <input type="text" name="ref_familiar<?= $cant_ref_act;?>" value="<?= $row2f["nombre"]?>" class="mayusculas" id="textfield" />
    </div>
    <div class="campb dosporch">
      <div>Domicilio</div>
...
<?php   };  // FIN DE MODIFICAR   ?>
  ...
  <?php if ($seccion != ''){?>
  <div class="save-btns position_static">
    <?php if ($seccion == '1'){?>
...
<div id="copy_ref0" style="display:none">
  ...
  <div class="campitem-cliente2">
    <div class="campb">
      <div>Nombre</div>
      <input type="text" name="ref_familiar" id="textfield"  class="mayusculas"/>
    </div>
    <div class="campb dosporch">
      <div>Domicilio</div>
