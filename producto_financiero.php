...
<div class="onecol"><span class="titlecol-ad">Productos financieros</span>

<div class="icons-men"><a href="agregar-producto_f.php"><img src="images/mas.svg" width="64" height="42" /></a></div>
<!--
...
<div class="divline"></div>
  ...
  <div class="initem">
    ...
    <div class="t-uname">ALIAS </div>
    <div class="t-contact">FECHA DE CREACION</div>
    <div class="t-uemail">ULTIMA EDICION</div>
...
<?php 
        ...
        if(!$pagina){
         ...
         $sqlpag= "SELECT * FROM producto_financiero  ";//PAGINADOR
      ...
      $sql1 = "SELECT * FROM producto_financiero ORDER BY id DESC LIMIT ".$inicio.",".$tamanio_pag;
      $result1 = mysql_query($sql1, $conn1);
		  while($row1 = mysql_fetch_array($result1)){
?>
  <a class="initem"  href="agregar-producto_f.php?id=<?php echo $row1["id"];?>"
  <?php if($row1["vendedor"] ==''){echo 'style="color:#FF0000 !important;"';};?>>
    <div class="ti uname"><?php echo str_pad($row1["id"], 3, "0", STR_PAD_LEFT);?></div>
    <div class="uname"><?php echo $row1["Alias"];?></div>
    <div class="t-contact"><?php echo $row1["fecha_creacion"];?></div>
    <div class="uemail"><?php echo $row1["fecha_modificacion"];?></div>
